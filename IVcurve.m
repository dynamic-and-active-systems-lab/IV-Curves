classdef IVcurve < handle
    ...
    %                       water qualities at 10 different irradiances
    %
    %The parameters above were then parsed out into individual IV curves
    %charaterized by current, voltage, temperature, depth, water quality,
    %irradiance, nominal irradiance, ID value, MPP, ISC, and VOC.
    %
    ...
    properties
        ...
        T       %The temperature that the IV curve was recorded at 
                %   (1x1 in °C)
        
        d       %The depth that the IV curve was simulated at 
                %   (1x1 in meters) (A -1 m depth corresponds to AM 1.5
                %   Spectrum, A -2 m depth corresponds to the 0 irr panel)
    ...
    methods
        function obj = IVcurve(I,V,T,d,quality,irr,nom,ID)
